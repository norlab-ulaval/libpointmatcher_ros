...
template
sensor_msgs::msg::PointCloud2 PointMatcher_ROS::pointMatcherCloudToRosMsg<float>(const PointMatcher<float>::DataPoints& pmCloud, const std::string& frame_id,
																			const rclcpp::Time& stamp);

template
sensor_msgs::msg::PointCloud2 PointMatcher_ROS::pointMatcherCloudToRosMsg<double>(const PointMatcher<double>::DataPoints& pmCloud, const std::string& frame_id,
																			 const rclcpp::Time& stamp);

template<typename T>
nav_msgs::msg::Odometry PointMatcher_ROS::pointMatcherTransformationToOdomMsg(const typename PointMatcher<T>::TransformationParameters& inTr,
...
template
nav_msgs::msg::Odometry PointMatcher_ROS::pointMatcherTransformationToOdomMsg<float>(const PointMatcher<float>::TransformationParameters& inTr,
																				const std::string& frame_id, const std::string& child_frame_id,
																				const rclcpp::Time& stamp);

template
nav_msgs::msg::Odometry PointMatcher_ROS::pointMatcherTransformationToOdomMsg<double>(const PointMatcher<double>::TransformationParameters& inTr,
																				 const std::string& frame_id, const std::string& child_frame_id,
																				 const rclcpp::Time& stamp);

template<typename T>
typename PointMatcher<T>::TransformationParameters PointMatcher_ROS::rosTfToPointMatcherTransformation(const geometry_msgs::msg::TransformStamped& transformStamped,
...
PointMatcher_ROS::rosTfToPointMatcherTransformation<float>(const geometry_msgs::msg::TransformStamped& transformStamped, const int& transformationDimension);

template
PointMatcher<double>::TransformationParameters
PointMatcher_ROS::rosTfToPointMatcherTransformation<double>(const geometry_msgs::msg::TransformStamped& transformStamped, const int& transformationDimension);

template<typename T>
geometry_msgs::msg::TransformStamped PointMatcher_ROS::pointMatcherTransformationToRosTf(const typename PointMatcher<T>::TransformationParameters& inTr,
																					const std::string& frame_id, const std::string& child_frame_id,
																					const rclcpp::Time& stamp)
{
	const Eigen::Affine3d eigenTr(
	...
	geometry_msgs::msg::TransformStamped tfTr = tf2::eigenToTransform(eigenTr);
...
template
geometry_msgs::msg::TransformStamped PointMatcher_ROS::pointMatcherTransformationToRosTf<float>(const PointMatcher<float>::TransformationParameters& inTr,
